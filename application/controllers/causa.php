...
class Causa extends CI_Controller{	
	...
	public function index(){
		...
		$this->view=array(
			...
			'scripts'=>array(
				...
				'<script type="text/javascript" src="'.base_url().'scripts/jquery.datatables.custom.js"></script>',
			...
			'login' => $this->login,
			'section' => 'lista',
			'content' => 'admin/causa/listar',
			'data' => $this->causas->all()
	...
	public function crear(){
		...
		if( !empty( $_POST ) ){ 
			...
			$this->form_validation->set_rules('nombre_causa', 'Nombre causa', 'trim|required|xss_clean|callback__alfanumeric');
			...
			if ( $this->form_validation->run() == FALSE ){
				$errores = array(
					'nombre'=>form_error('nombre_causa')
					);
				...
				if( $this->causas->crear( $this->input->post() ) == true ){			
	...
	public function editar( $id = null ){
		...
		if($_POST){ 
			...
			if ( $this->form_validation->run() == FALSE ){
				...
				$this->session->set_flashdata('errores',$errores);	
				redirect('causa/editar/'.$id);	
			
			}else{
									
				if( $this->causas->editar( $id, $this->input->post() ) == true ){			
	...
	public function eliminar( $id = null ){
		...
		if( $this->causas->eliminar( $id ) == true ){

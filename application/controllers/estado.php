...
class Estado extends CI_Controller{	
	...
	public function index(){
		...
		$this->view=array(
			...
			'login' => $this->login,
			'section' => 'lista',
			'content' => 'admin/estado/listar',
			'data' => $this->estados->all()
	...
	public function crear(){
		...
		if( !empty( $_POST ) ){ 
			...
			$this->form_validation->set_rules('nombre_estado', 'Nombre estado', 'trim|required|xss_clean|callback__alfanumeric');
			...
			if ( $this->form_validation->run() == FALSE ){
				$errores = array(
					'nombre'=>form_error('nombre_estado')
					);
				...
				if( $this->estados->crear( $this->input->post() ) == true ){			
	...
	public function editar( $id = null ){
		...
		if( !empty( $_POST ) ){ 
			...
			if ( $this->form_validation->run() == FALSE ){
				...
				$this->session->set_flashdata('errores',$errores);	
				redirect('estado/editar/'.$id);
			
			}else{
									
				if( $this->estados->editar( $id, $this->input->post() ) == true ){			
	...
	public function eliminar( $id = null ){
		...
		if( $this->estados->eliminar( $id ) == true ){

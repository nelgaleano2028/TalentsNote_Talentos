...
==================================== */	
	...
	public function editar( $id = null, $values = array() ){
		...
		// Editar registros					
	    if( $this->db->update( $this->table, $values, array( 'id_cargo' => $id ) ) )
        	return true;
        else
        	return false;
	...
	public function eliminar( $id = null ){
		...
		$query = $this->db->get_where('t_ingeniero',array('id_cargo'=> $id ));
		
		if($query->num_rows==0){
			
			// Eliminar registro
			$this->db->delete( 't_cargo', array('id_cargo'=>$id));
			return true;
		}else{
			return false;
		}
...
==================================== */	
	public function id( $id = null ){
		...
		// Consulta
		$query = $this->db->get_where( $this->table, array( 'id_cargo' => $id ) );

  ...
  <div class="static-content">
      <div class="page-content">
        <ol class="breadcrumb">
            ...
            <li class=""><a href="<?php echo base_url()?>ver_incidente/">Incidentes</a></li>
        ...
        <div class="container-fluid">
          <div data-widget-group="group1" class="ui-sortable">
            <div class="row">
                <div class="col-xs-12">
                    <form action="<?php echo base_url() ?>clientes/nuevo_incidente" id="formincidente" method="post" enctype="multipart/form-data" class="form-horizontal">
                    <div class="panel panel-midnightblue" data-widget="{'draggable:false'}" data-widget-static=""
                        ...
                        <?php if($errors['errors']){
                                echo '<div class="alert alert-danger" role="alert">'.$errors['errors'].'</div>';
                            }
                        ?>

            ...
            <div class="row">
              <div class="col-xs-12">
                <div class="panel panel-midnightblue" data-widget="{'draggable:false'}" data-widget-static=""
                    ...
                    <form  action="<?php echo base_url() ?>clientes/perfil_cliente/<?php echo $data[0]['id_contacto'] ?>" method="post" id="formperfil" enctype="multipart/form-data" class="form-horizontal">
                    ...
                    <div class="panel-body" id="table_incidente">
                          <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" required name="telefono" id="telefono"  class="form-control" value="<?php echo set_value('telefono', $data[0]['telefono']) ?>"/>
                            </div>
                          </div>
                          <div class="form-group">

  ...
  <div class="static-content">
      <div class="page-content">
        <ol class="breadcrumb">
            ...
            <li class=""><a href="<?php echo base_url()?>causas/">Causas</a></li>
              ...
              <div class="col-xs-12">
                <div class="panel panel-midnightblue" data-widget="{'draggable:false'}" data-widget-static=""
                    ...
                    <div class="panel-body" id="table_incidente">
                        <form action="<?php echo base_url()?>causa/editar/<?php echo $data[0]['id_causa'] ?>" class="form-horizontal" method="post" id="form">
                            <div class="form-group">
                                <label class="col-sm-2 control-label">Causa*</label>
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" name="nombre_causa" required id="nombre_causa" value="<?php echo set_value('nombre_causa',$data[0]['nombre_causa'])?>">
                                </div>
                            </div>
                    </div>

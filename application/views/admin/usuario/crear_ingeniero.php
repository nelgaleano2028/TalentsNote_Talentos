  ...
  <div class="static-content">
      <div class="page-content">
        <ol class="breadcrumb">
            ...
            <li class=""><a href="<?php echo base_url()?>usuario/">Ingeniero</a></li>
              ...
              <div class="col-xs-12">
                <div class="panel panel-midnightblue" data-widget="{'draggable:false'}" data-widget-static=""
                    ...
                    <div class="panel-body">
                        <form action="<?php echo base_url() ?>usuario/crear_ingeniero" method="post" class="form-horizontal" id="form" autocomplete="off">

  ...
  <div class="static-content">
      <div class="page-content">
        <ol class="breadcrumb">
	        ...
	        <li class=""><a href="<?php echo base_url()?>estadistica/reportesatencion">Reporte Atención</a></li>
        </ol> 
            ...
            <div class="row">
                ...
                <div class="panel panel-midnightblue" data-widget="{'draggable:false'}" data-widget-static=""
                    ...
                    <div class="panel-heading">
                      <h2>Reporte Atención Por Mes</h2 >
                    </div>
                	...
                	<div class="panel panel-midnightblue" id="estadistica" style="display:none">
                    	<div class="panel-heading">
	                      <h2>El promedio de Atención en Minutos es de:&nbsp;</h2><p id="resultado" style="font-size:15px;"></p>
	                    </div>

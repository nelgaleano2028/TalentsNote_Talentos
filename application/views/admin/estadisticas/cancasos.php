      ...
      <div class="page-content">
        <ol class="breadcrumb">
          <li class=""><a href="<?php echo base_url()?>admin">Home</a></li>
            ...
            <li class=""><a href="<?php echo base_url()?>estadistica/reportescatidadcasos">Casos por mes</a></li>
        </ol> 
              ...
              <div class="col-xs-12">
                <div class="panel panel-midnightblue" data-widget="{'draggable:false'}" data-widget-static=""
                    ...
                    <div class="panel-heading">
                      <h2>Reportes de Cantidad de casos por mes</h2 >
                    </div>
                ...
                <div class="panel panel-midnightblue" id="estadistica" style="display:none">
                	<div class="panel-heading">
                      <h2>La cantidad de casos es de:&nbsp;</h2><p id="resultado" style="font-size:15px;"></p>
                    </div>

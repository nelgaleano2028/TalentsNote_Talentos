  ...
  <div class="static-content">
      <div class="page-content">
        <ol class="breadcrumb">
            ...
            <li class=""><a href="<?php echo base_url()?>estadistica/reportescatidadcasosingenieros">Cantidad de Casos</a></li>
        </ol> 
              ...
              <div class="col-xs-12">
                <div class="panel panel-midnightblue" data-widget="{'draggable:false'}" data-widget-static=""
                    ...
                    <div class="panel-heading">
                      <h2>Reportes de cantidad de casos</h2 >
                    </div>
                ...
                <div class="panel panel-midnightblue" id="estadistica" style="display:none">
                	<div class="panel-heading">
                      <h2>Cantidad de casos de ingeniero</h2><p id="resultado" style="font-size:15px;"></p>
                    </div>
					<input type="hidden" id="recogerhoraLLegada">

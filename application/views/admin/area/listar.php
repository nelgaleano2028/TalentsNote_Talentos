        ...
        <div class="container-fluid">
            <div class="row">
                <div class="panel-heading">
                    <h2 class="panel-head">Areas Registradas</h2 >
                    <a href="#" data-toggle="modal" class="btn btn-primary btn-crear" data-target="#mimodal">Crear <i class="fa fa-plus"></i></a>
                    <!-- <a class="btn btn-primary btn-crear" href="<?php echo base_url()?>area/crear/" >Crear <i class="fa fa-plus"></i></a>  -->
                </div>
                            ...
                            <table class="table table-striped table-bordered" id="example">
                                ...
                                <?php if(!empty( $data)):  foreach($data as $value):?>
                                  ...
                                  <tr>
                                      ...
                                      <td class="center"><a href="<?php echo base_url() ?>area/editar/<?php echo $value['id_area']?>" title="Editar elemento" >
                                      <img src="<?php echo base_url()?>images/editar.png" width="20" height="20" title="Editar elemento" alt="editar"/></a>
                                      </td>
                                      <td class="center"><a href="<?php echo base_url() ?>area/eliminar/<?php echo $value['id_area']?>" onclick="javascript: if( !confirm( 'Quiere eliminar este elemento ?' ) ) return false;">

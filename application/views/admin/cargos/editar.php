  ...
  <div class="static-content">
      <div class="page-content">
        <ol class="breadcrumb">
          ...
          <li class="active"><a href="<?php echo base_url()?>cargos">Cargos</a></li>
          <li class="active"><a href="<?php echo base_url()?>cargos/editar/<?php echo $data[0]['id_cargo'] ?>">Editar</a></li>
        </ol> 
              ...
              <div class="col-xs-12">
                <div class="panel panel-midnightblue" data-widget="{'draggable:false'}" data-widget-static=""
                    ...
                    <div class="panel-body" id="table_incidente">
                        <form action="<?php echo base_url()?>cargos/editar/<?php echo $data[0]['id_cargo'] ?>" class="form-horizontal" method="post" id="cargos">
                            <div class="form-group">
                                <label class="col-sm-2 control-label">Cargo*</label>
                                <div class="col-sm-8">
                                    <input type="text" required class="form-control" name="nombre_cargo" id="nombre_cargo" value="<?php echo set_value('nombre_cargo',$data[0]['nombre_cargo'])?>">
                                </div>
                            </div>
                    </div>

              ...
              <div class="col-xs-12">
                <div class="panel panel-midnightblue" data-widget={"draggable":"false"} data-widget-static style="visibility: visible; opacity: 1; display: block; transform: translateY(0px);">
                    ...
                    <div class="panel-body" id="table_incidente">
                        <form action="<?php echo base_url()?>pensiones/editar/<?php echo $data[0]['id_pensiones'] ?>" class="form-horizontal" method="post" id="formu">
                            <div class="form-group">
                                <label class="col-sm-2 control-label">Pensión*</label>
                                <div class="col-sm-8">
                                    <input type="text" class="form-control"
                                    name="nombre_pensiones" required  pattern="[a-zA-Z9-0\sáéíóúñ]*" title="Debe ser alfanumerico" id="nombre_pensiones" value="<?php echo set_value('nombre_pensiones',$data[0]['nombre_pensiones'])?>">
                                </div>
                            </div>
                    </div>
                    <div class="form-boton panel-footer">
                        <div class="row">
                            <div class="col-sm-8 col-sm-offset-2">
                                <input type="submit" id="envi" class="form-insert btn btn-primary"  value="Guardar"/>

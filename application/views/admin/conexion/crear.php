...
<!--content-main-->
<div id="content-main">    
        <div class="title-cliente"><span><strong>Crear Conexión</strong></span></div>
        <div class="content-on-blank">
        	...
        	<form name="form" action="<?php echo base_url() ?>conexion/crear" method="post" id="form">
                	...
                	<div class="form-l formulario">
                        ...
                        <select id="id_tipo_conexion" name="id_tipo_conexion" class="requiered">
                                ...
                                <?php if( !empty( $tipo_conexion ) ): foreach( $tipo_conexion as $value ): ?>
                                    ...
                                    <option value="<?php echo $value['id_tipo_conexion'] ?>"><?php echo $value['tipo_conexiones'] ?></option>
                ...
                <div class="fondo-form">
                	<div class="form-l formulario">
                        ...
                        <input type="text" name="detalles" id="detalles" value="<?php echo set_value('detalles') ?>"/>
                    </div>
                </div>

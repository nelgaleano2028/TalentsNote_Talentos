    ...
    <div class="static-content">
        <div class="page-content">
          	<ol class="breadcrumb">
	            ...
	            <li class=""><a href="<?php echo base_url()?>usuario/">Incidentes Resueltos</a></li>
          	</ol> 
	                          	...
	                          	<table class="table table-striped table-bordered" id="example">
					                 ...
					                 <tbody>
					                    ...
					                    <tr >
					                        ...
					                        <td><?php echo anchor( '/ingeniero/incidente_resuelto/'.$value['id_incidencia'].'/'.$value['id_ingeniero'], $value['asunto'] )?></td>

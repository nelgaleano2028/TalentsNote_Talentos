$( document ).ready(function() {
     ...
     $("#ingeniero").attr('disabled','disabled');
      ...
      $("#anio").bind('change',function(){
		...
		$("#ingeniero").removeAttr('disabled');
                
                $( '#est_ing' ).bind( 'click', function(){
                    
                    $.ajax({
                    url:  General.base+'estadistica/resultados8/',
                      type: 'POST',
                      data: 'anio='+ $("#anio option:selected").val()+'&mes='+$("#mes option:selected").val()+'&ingeniero='+$("#ingeniero option:selected").val(),
                      dataType: 'json',
                      cache: false,
